...
public class SwipeMenuRecyclerView extends RecyclerView {
     ...
     */
    public SwipeMenuRecyclerView setSwipeItemClickListener(SwipeItemClickListener itemClickListener) {
        if (itemClickListener == null) return this;
     ...
     */
    public SwipeMenuRecyclerView setSwipeMenuCreator(SwipeMenuCreator menuCreator) {
        if (menuCreator == null) return this;
     ...
     */
    public SwipeMenuRecyclerView setSwipeMenuItemClickListener(SwipeMenuItemClickListener menuItemClickListener) {
        if (menuItemClickListener == null) return this;
    ...
    public SwipeMenuRecyclerView setAdapterX(Adapter adapter) {
        setAdapter(adapter);
        return this;
    }
    ...
    private static class ItemLongClick implements SwipeItemLongClickListener {
        private final SwipeMenuRecyclerView mRecyclerView;
        private final SwipeItemLongClickListener mCallback;
