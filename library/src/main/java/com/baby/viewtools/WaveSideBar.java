...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.commonAttr);
        ...
        mTextSize = a.getDimensionPixelSize(R.styleable.commonAttr_appTextSize, context.getResources().getDimensionPixelSize(R.dimen.textSize));
        mHintTextSize = a.getDimensionPixelSize(R.styleable.commonAttr_appHintTextSize, context.getResources().getDimensionPixelSize(R.dimen.hintTextSize));
        mWaveColor = a.getColor(R.styleable.commonAttr_appBackgroundColor, Color.parseColor("#bef9b81b"));
        mRadius = a.getDimensionPixelSize(R.styleable.commonAttr_appRadius, context.getResources().getDimensionPixelSize(R.dimen.radius));
        mCircleRadius = a.getDimensionPixelSize(R.styleable.commonAttr_appCircleRadius, context.getResources().getDimensionPixelSize(R.dimen.circleRadius));
        a.recycle();
