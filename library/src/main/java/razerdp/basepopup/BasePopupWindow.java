...
public abstract class BasePopupWindow implements BasePopup, PopupWindow.OnDismissListener, PopupTouchController {
    ...
    private final Animation.AnimationListener mAnimationListener = new SimpleAnimationUtils.AnimationListenerAdapter() {
        @Override
    ...
    private void initView(Context context, int w, int h) {
        ...
        mDismissView = getPopupWindowView();
    ...
    protected Animation getTranslateHorizontalAnimation(float start, float end, int durationMillis) {
        return SimpleAnimationUtils.getTranslateHorizontalAnimation(start, end, durationMillis);
    }
